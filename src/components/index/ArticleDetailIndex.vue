...
<style>
	.page-background {
	  /* 设置背景图片 */
	  background-image: url('https://originalfileserver.aminer.cn/sys/aminer/homepage/home-top-bg.png');
